=== Presentation Block ===
Contributors:      ellatrix, wordpressdotorg, isvictorious, danhthong, alilyons
...
3. When the popup appears select the presentation-block-x.x.zip file from your desktop. (The 'x.x' will change depending on the current version number).
