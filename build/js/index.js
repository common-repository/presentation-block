...
$6aba998320558280$var$registerBlockType("slide/slide", {
    ...
    edit: ({ attributes: attributes, setAttributes: setAttributes, className: className })=>{
        ...
        return $6aba998320558280$var$e($6aba998320558280$var$Fragment, null, $6aba998320558280$var$e($6aba998320558280$var$InspectorControls, null, $6aba998320558280$var$e("div", {
            className: "block-editor-block-card"
        }, $6aba998320558280$var$e($6aba998320558280$var$Button, {
            isDefault: true,
            isPrimary: true,
            onClick: ()=>{
                const { createBlock: createBlock } = wp.blocks;
                const { insertBlock: insertBlock } = wp.data.dispatch("core/editor");
                const slideBlock = createBlock("slide/slide");
                insertBlock(slideBlock);
            }
        }, $6aba998320558280$var$__("Add New Slide"))), $6aba998320558280$var$e($6aba998320558280$var$PanelBody, {
...
$09c8b9c8d5e2e67c$var$registerPlugin("slide", {
    render: ()=>{
        ...
        return [
            ...
            $09c8b9c8d5e2e67c$var$e($09c8b9c8d5e2e67c$var$PluginPostStatusInfo, {}, $09c8b9c8d5e2e67c$var$e($09c8b9c8d5e2e67c$var$Button, {
                isDefault: true,
                isPrimary: true,
                onClick: ()=>{
                    const { createBlock: createBlock } = wp.blocks;
            ...
            }, $09c8b9c8d5e2e67c$var$__("Add New Slide"))),
